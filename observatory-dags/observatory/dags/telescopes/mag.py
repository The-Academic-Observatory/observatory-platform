    ...
    def transform(**kwargs):
        ...
        for release in releases:
            ...
            release_extracted_path = os.path.join(
                telescope_path(SubFolder.extracted, MagTelescope.DAG_ID), release.source_container
            )
            release_transformed_path = os.path.join(
                telescope_path(SubFolder.transformed, MagTelescope.DAG_ID), release.source_container
            )
