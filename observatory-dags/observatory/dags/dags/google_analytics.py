...
from observatory.dags.telescopes.google_analytics import GoogleAnalyticsTelescope
...
for telescope in telescopes:
    google_analytics_telescope = GoogleAnalyticsTelescope(telescope.organisation, telescope.extra)
