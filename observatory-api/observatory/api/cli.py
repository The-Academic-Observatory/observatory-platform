...
@click.option('--cloud-endpoints',
              is_flag=True,
              default=False,
              help='Generate OpenAPI config for Cloud Endpoints.')
@click.option('--api-client',
              is_flag=True,
              default=False,
              help='Generate OpenAPI config for OpenAPI client generation.')
