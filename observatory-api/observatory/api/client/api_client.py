...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.delete_organisation  # this is an instance of the class Endpoint
        api_instance.delete_organisation()  # this invokes api_instance.delete_organisation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_organisation.callable or self.callable in this class
