...
from observatory.api.client import rest
from observatory.api.client.configuration import Configuration
from observatory.api.client.exceptions import ApiTypeError, ApiValueError, ApiException
from observatory.api.client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.delete_dataset_release  # this is an instance of the class Endpoint
        api_instance.delete_dataset_release()  # this invokes api_instance.delete_dataset_release.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_dataset_release.callable or self.callable in this class
