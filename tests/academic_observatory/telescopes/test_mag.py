...
from academic_observatory.telescopes.mag import list_mag_release_files, transform_mag_file, transform_mag_release, \
    db_load_mag_release
from academic_observatory.utils.data_utils import _hash_file
from academic_observatory.utils.gc_utils import upload_files_to_cloud_storage
from tests.academic_observatory.config import random_id, test_fixtures_path
