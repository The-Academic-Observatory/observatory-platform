...
from observatory.dags.workflows.jstor_telescope import JstorRelease, JstorTelescope, get_label_id
...
class TestJstorTelescope(ObservatoryTestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.country_report = {
            "path": test_fixtures_path("telescopes", "jstor", "country_20210401.tsv"),
        ...
        self.institution_report = {
            "path": test_fixtures_path("telescopes", "jstor", "institution_20210401.tsv"),
