...
class TestJstor(ObservatoryTestCase):
    ...
    def test_telescope(self):
        ...
        with env.create():
            ...
            release = SnapshotRelease(telescope.dag_id, release_date)

            release_id = release.release_id
            download_folder = release.download_folder
            extract_folder = release.extract_folder
            transform_folder = release.transform_folder
