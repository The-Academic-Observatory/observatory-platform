...
import pendulum
import vcr
from observatory.dags.telescopes.crossref_fundref import (CrossrefFundrefRelease,
...
class TestCrossrefFundref(ObservatoryTestCase):
    ...
    def test_telescope(self):
        ...
        with env.create():
            ...
            actual_release_info = ti.xcom_pull(key=CrossrefFundrefTelescope.RELEASE_INFO,
            ...
            release = CrossrefFundrefRelease(telescope.dag_id, release_info[0]['date'], release_info[0]['url'])
    ...
    def test_list_releases(self):
        ...
        with vcr.use_cassette(cassette_path):
            releases = list_releases(datetime(2014, 3, 1), datetime(2020, 6, 1))
