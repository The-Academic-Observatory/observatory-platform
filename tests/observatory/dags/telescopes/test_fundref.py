...
from observatory.dags.telescopes.fundref import (FundrefRelease,
                                                 FundrefTelescope,
...
class TestFundref(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fundref_nested_element = ET.Element(
            '{http://data.crossref.org/fundingdata/xml/schema/grant/grant-1.2/}country', attrib={
                '{http://www.w3.org/1999/02/22-rdf-syntax-ns#}resource': 'http://sws.geonames.org/6252001/'
            })
    ...
    def test_list_releases(self, mock_variable_get):
        ...
        cassette_path = os.path.join(test_fixtures_path(), 'vcr_cassettes', 'list_fundref_releases.yaml')
    ...
    def test_download_release(self, mock_variable_get):
        ...
        data_path = 'data'
        mock_variable_get.return_value = data_path
        cassette_path = os.path.join(test_fixtures_path(), 'vcr_cassettes', 'fundref_download_release.yaml')
    ...
    def test_parse_fundref_registry_rdf(self, mock_variable_get):
        ...
        with CliRunner().isolated_filesystem():
            ...
            self.assertListEqual(funders, [{
                'funder': 'http://dx.doi.org/10.13039/100000001',
                'pre_label': 'National Science Foundation',
                ...
                'narrower': ['http://dx.doi.org/10.13039/100005447', 'http://dx.doi.org/10.13039/100014591',
                             ...
                             'http://dx.doi.org/10.13039/100014071'],
                'broader': [],
                'modified': '2020-02-28T20:45:11.000000',
                'created': '2009-07-06T18:53:11.000000',
                'funding_body_type': 'National government',
                'funding_body_sub_type': 'gov',
                'region': 'Americas',
                'country': None,
                'country_code': 'usa',
                'state': None,
                ...
                'funder': 'http://dx.doi.org/10.13039/100000002',
                'pre_label': 'National Institutes of Health',
                'alt_label': ['NIH'],
                ...
                'broader': ['http://dx.doi.org/10.13039/100000016'],
                'modified': '2020-03-12T22:59:31.000000',
                'created': '2009-07-06T18:53:11.000000',
                'funding_body_type': 'National government',
                'funding_body_sub_type': 'gov',
                'region': 'Americas',
    ...
    def test_add_funders_relationships(self, mock_variable_get):
        ...
        with CliRunner().isolated_filesystem():
            ...
            self.assertListEqual(funders, [{
                ...
                'notation': None,
                'children': [{
                                 'funder': 'http://dx.doi.org/10.13039/100005447',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100014591',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100014073',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000081',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000076',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100015815',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100005716',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100014072',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100014411',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100010608',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000088',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100005441',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000179',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000085',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000084',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000083',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000086',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100014074',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100014071',
                                 'name': None,
                                 'children': []
                             }],
                'bottom': True,
                ...
                'notation': None,
                'children': [{
                                 'funder': 'http://dx.doi.org/10.13039/100006545',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100012893',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000066',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000053',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100006086',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000092',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000052',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000135',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100008460',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000093',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000097',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000065',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000118',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000072',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000060',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000061',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100006084',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100009633',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000055',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100006108',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000071',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000069',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000054',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000056',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100006955',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000064',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000049',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000098',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000057',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000026',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000025',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100005440',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000096',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000124',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000027',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000070',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000051',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100006085',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000062',
                                 'name': None,
                                 'children': []
                             }, {
                                 'funder': 'http://dx.doi.org/10.13039/100000050',
                                 'name': None,
                                 'children': []
                             }],
                'bottom': True,
                'parents': [{
                                'funder': 'http://dx.doi.org/10.13039/100000016',
                                'name': None,
                                'parent': []
                            }],
                'top': True
