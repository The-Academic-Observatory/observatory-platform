...
def cleanup(dag_id: str, logical_date: str, workflow_folder: str = None, retention_days=31) -> None:
    """Delete all files, folders and XComs associated from a release.

    :param dag_id: The ID of the DAG to remove XComs
    :param logical_date: The execution date of the DAG run
    ...
    delete_old_xcoms(dag_id=dag_id, logical_date=logical_date, retention_days=retention_days)
