...
def make_schema(backend_type: str) -> Dict:
    ...
    schema["google_cloud"] = {
        ...
        "type": "dict",
        "schema": {
            "project_id": {"required": True, "type": "string", "check_with": customise_pointer},
            "credentials": {
                "required": True,
                "type": "string",
    ...
    if is_backend_terraform_api:
        schema["security"] = {
            ...
            "type": "dict",
            "schema": {
                "auth0_client_id": {"required": True, "type": "string", "check_with": customise_pointer},
                "auth0_client_secret": {"required": True, "type": "string", "check_with": customise_pointer},
                "flask_secret_key": {"required": True, "type": "string", "check_with": customise_pointer},
            },
        }
        schema["api"] = {
            "required": True,
