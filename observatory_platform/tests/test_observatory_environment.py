...
from observatory_platform.bigquery import bq_create_dataset, bq_load_table, bq_table_id
from observatory_platform.config import AirflowVars
from observatory_platform.gcs import gcs_upload_file, gcs_blob_uri
...
from observatory_platform.workflow import Workflow, Release
...
from tests.observatory_platform.test_observatory_environment import TelescopeTest
...
class TestHttpserver(ObservatoryTestCase):
    def test_serve(self):
        ...
        with patch("observatory_platform.observatory_environment.ThreadingHTTPServer.serve_forever") as m_serve:
